...
* 實驗場景可參考 [Project_Competition_Deployment2024.pdf](/Report/Project_Competition_Deployment2024.pdf)。
* 實驗報告可參考 [Final_Report.pdf](/Report/Final_Report.pdf)。
...
## 實驗結果
* 區域定位：能正確判斷 5 個測試點的區域。
* 座標定位：對於隨有測試點，誤差皆小於 50 cm。
